...
class CylinderActuatedStation(RobotSystemBase):
    ...
    def __init__(
        ...
        parser.AddModelsFromUrl("package://planning_through_contact/pusher_floating_hydroelastic_actuated.sdf")[0]
        ...
        self.slider = AddSliderAndConfigureContact(sim_config, self.station_plant, self._scene_graph)
        ...
        self._robot_model_instance = self.station_plant.GetModelInstanceByName(self.robot_model_name)
        builder.Connect(
        ...
        self.station_plant.SetDefaultPositions(self._robot_model_instance, self._sim_config.pusher_start_pose.pos())

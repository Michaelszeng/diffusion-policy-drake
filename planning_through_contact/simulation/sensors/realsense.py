...
class RealsenseCamera:
    def __init__(self, name: str, serial_number: str, config: RealsenseCameraConfig):
        ...
        rsconfig.enable_stream(rs.stream.color, config.width, config.height, rs.format.bgr8, config.fps)
    ...
    def start_recording(self):
        ...
        self._recording_thread = threading.Thread(target=self._record, args=(self._stop_event,))

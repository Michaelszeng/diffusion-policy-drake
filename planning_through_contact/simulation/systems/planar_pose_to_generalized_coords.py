...
class PlanarPoseToGeneralizedCoords(LeafSystem):
    ...
    def DoCalcOutput(self, context, output):
        ...
        planar_pose = PlanarPose(planar_pose_input[0], planar_pose_input[1], planar_pose_input[2])
        output.set_value(planar_pose.to_generalized_coords(self._z_value, self._z_axis_is_positive))
